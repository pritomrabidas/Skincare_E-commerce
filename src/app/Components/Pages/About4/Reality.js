      ...
      <div className="container mx-auto ">
        <div className="grid grid-cols-2 items-center justify-center">
          <div className="flex gap-4 p-4">
            <div
              className="w-1/2 h-[450px] bg-cover bg-no-repeat bg-center rounded-md"
              style={{ backgroundImage: "url('/about4/about-2.jpg')" }}
            ></div>
            <div
              className="w-1/2 h-[450px] bg-cover bg-no-repeat bg-center rounded-md mt-10"
              style={{ backgroundImage: "url('/about4/about-3.jpg')" }}
            ></div>
          </div>
          <div className=" p-4">
            <h2 className="text-4xl font-bold text-primary font-NunitoFont">
