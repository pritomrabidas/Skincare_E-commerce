    ...
    >
      <div className="absolute inset-0 bg-[#0000004a] bg-opacity-50 flex items-center justify-center">
        <div className="text-center px-6">
          <h2 className="text-4xl font-bold text-white font-NunitoFont mb-6">
          ...
          <Link
            href="/contact"
            className="bg-white text-primary px-6 py-3 rounded-md text-base font-Popins font-medium hover:bg-secandari hover:text-white duration-400"
          >
            Contact Us
          </Link>
        </div>
